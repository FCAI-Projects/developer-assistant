...
export type Query = {
  ...
  note: Note;
  project: Project;
  projectStatus: Array<ProjectLists>;
  projectStatusById: ProjectLists;
...
export type ProjectsQuery = {
  __typename?: "Query";
  projects: Array<{ __typename?: "Project"; id: string; name: string; describtion: string }>;
};
...
export type UpdateProjectMutation = {
  __typename?: "Mutation";
  updateProject: { __typename?: "Project"; name: string; clientEmail: string; describtion: string };
};
...
export type ProjectListsQuery = {
  __typename?: "Query";
  projectStatus: Array<{ __typename?: "ProjectLists"; id: string; name: string; index: number; color: string }>;
};
...
export type TasksQuery = {
  ...
  tasks: Array<{
    ...
    index: number;
    description: string;
    status: { __typename?: "ProjectLists"; id: string; name: string; color: string };
    project: { __typename?: "Project"; name: string; id: string };
  }>;
};
...
export type CreateUserMutation = {
  __typename?: "Mutation";
  createUser: { __typename?: "UserResponse"; token: string };
};
...
export function useRemoveRoleMutation(
  baseOptions?: Apollo.MutationHookOptions<RemoveRoleMutation, RemoveRoleMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useProjectListsQuery(
  baseOptions: Apollo.QueryHookOptions<ProjectListsQuery, ProjectListsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ProjectListsQuery, ProjectListsQueryVariables>(ProjectListsDocument, options);
}
export function useProjectListsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProjectListsQuery, ProjectListsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
